      ...
      <div class="upload-grid">
        <div class="upload-item">
          ...
          <label class="upload-control">
            <input class="upload-input" type="file" accept="image/*" @change="$emit('file-change', 'id_front', $event)" />
        ...
        <div class="upload-item">
          ...
          <label class="upload-control">
            <input class="upload-input" type="file" accept="image/*" @change="$emit('file-change', 'id_back', $event)" />
            <span class="upload-btn">选择文件</span>
          </label>
        ...
        <div class="upload-item">
          ...
          <label class="upload-control">
            <input class="upload-input" type="file" accept=".pdf,.doc,.docx" @change="$emit('file-change', 'resume', $event)" />
            <span class="upload-btn">选择文件</span>
          </label>
