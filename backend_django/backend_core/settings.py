...
OA_SSO_AUTO_CREATE_USER = get_bool("OA_SSO_AUTO_CREATE_USER", False)
OA_SSO_AUTO_CREATE_REGION_CODE = str(os.getenv("OA_SSO_AUTO_CREATE_REGION_CODE", "dongying") or "dongying").strip()
OA_HRM_PROFILE_SYNC_ENABLED = get_bool("OA_HRM_PROFILE_SYNC_ENABLED", False)
OA_HRM_PROFILE_SYNC_ONCE = get_bool("OA_HRM_PROFILE_SYNC_ONCE", True)
