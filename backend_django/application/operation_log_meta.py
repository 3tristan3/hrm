...
OPERATION_ACTION_LABELS = {
    ...
    "CONFIRM_HIRE": "发放offer",
    "BATCH_CONFIRM_HIRE": "批量发放offer",
    "CONFIRM_ONBOARD": "确认入职",
    "BATCH_CONFIRM_ONBOARD": "批量确认入职",
    "OA_PUSH_SUCCESS": "OA推送成功",
    "OA_PUSH_FAILED": "OA推送失败",
    "OA_PUSH_RETRY": "重发OA推送",
